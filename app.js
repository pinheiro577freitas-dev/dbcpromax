document.addEventListener('DOMContentLoaded', () => {
    ...
    function buildLiveReport() {
        ...
        const subjectReports = criminalCcs.map((cc, index) => {
        ...
        const evidenceSections = `--------------------------📸 Evidências 📸----------------------------\n${subjectReports.map(subject => subject.evidence).join('\n\n')}`;
        const finesSection = `-------------------------💰 Coimas Extras 💰-------------------------\n${subjectReports.map(subject => subject.fines).join('\n\n')}`;
        const criminalSections = `${evidenceSections}\n${finesSection}`;
...
${criminalSections}
----------------------------⚖️ Medição ⚖️----------------------------
Mediação ao cargo da DBC . 100% coima 0% sentença
---------------------------📝 Ocorrência 📝----------------------------
Líder da ocorrência:
➙ ${leader}
